...
async def main():
    ...
    global character_frozen
    global shopping_enabled
    global printer_guy_progress
    global alpha
    global money
    global outrage
    global inspo
    ...
    global has_paperboy
    global has_printer
    global has_printing_press
    global timer_started
    global start_time
    global holding_news
    global paperboy_holding_news
    global play_black
    global history_black
    global credits_black
    global sequence
    ...
    while True:
        ...
        if screen_num == 1:
            ...
            if not shopping:
                ...
                if tutorial_stage == 3:
                    if inspo < 20: draw_thought_bubble(screen, 860, 157, ["Move to the desk", "by pressing the left arrow.", "Type letters at the desk", "to gain inspiration."])
